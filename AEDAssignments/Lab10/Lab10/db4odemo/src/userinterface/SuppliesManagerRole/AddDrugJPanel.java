...
public class AddDrugJPanel extends javax.swing.JPanel {
    ...
    public AddDrugJPanel(JPanel userProcessContainer,Organization organization,Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        drugType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "a", "b" }));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
            ...
            txtProdQuan.getText().equals(""))
        {
            ...
            Product p = new Product(txtProdName.getText(),Integer.parseInt(txtProdID.getText()),txtDescription.getText(), Double.parseDouble(txtPrice.getText()),Integer.parseInt(txtProdQuan.getText()),type,supplierName,"Drug");
            p.setImage(i);

            organization.getProductDirectory().addDrug(p);
