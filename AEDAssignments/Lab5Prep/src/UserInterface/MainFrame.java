...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(101, 642));
    ...
    private void btnSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierActionPerformed
       ...
       if(adminUser.getSuppDir().getSupplierList().size()==0)
       {
           JOptionPane.showMessageDialog(null, "Please enter atleast one Supplier to view !");
       }
       else
       {
    ...
    private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        // TODO add your handling code here:
         if(adminUser.getCustDir().getCustomerList().size()==0)
       {
           JOptionPane.showMessageDialog(null, "Please enter atleast one Customer to view !");
       }
       else
       {
        CardLayout layout = (CardLayout)panelRight.getLayout();
